						...
						<form action="<?php echo base_url('welcome/search_doc')?>" method="post">
							...
							<div class="input-group  d-flex ">
								<div class="col-lg-3 col-md-3 col-sm-12 my-2 align-self-center ">
									<input type="search" placeholder="Area" name="area" class="form-control">
								</div>

								<div class="col-lg-3 col-md-3 my-2 col-sm-12 align-self-center ">
									<input type="search" placeholder="Filter Speciality" name="speciality"
										   class="form-control">
								</div>

								<div class="col-lg-3 col-md-3 my-2 col-sm-12 align-self-center ">
									<input type="search" placeholder="Filter Hospital" name="hospital"
										   class="form-control">
								</div>
		...
		<div class="row justify-content-center">
			...
			foreach($data as $row)
			{
				...
				<div class="col-md-4 col-lg-4 col-sm-6 d-flex mb-4">
					<div class="doctors align-self-center w-100 h-100">
						...
						<div class="align-self-center doctor-details mt-4">
							<span class="details-info"><b>Hospital:</b> Islami Bank Central Hospital</span>
