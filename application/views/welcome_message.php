						...
						<form action="<?php echo base_url('welcome/search_hospital')?>" method="post">
							...
							<div class="input-group  d-flex ">
								<div class="col-lg-4 col-md-4 col-sm-12 my-2 align-self-center ">
									<input type="search" placeholder="Hospital Name" name="name" class="form-control">
								</div>
		...
		<div class="row justify-content-center">
			...
			foreach($data as $row)
			{
				...
				<div class="col-md-4 col-lg-4 col-sm-6 d-flex mb-4">
					<div class="hospitals align-self-center h-100 w-100">

						<h4><?php echo $row->name?></h4>
						<span class="address"><b>Degree:</b> <?php echo $row->degree?></span>
						<span class="contact"><b>Speciality:</b> <?php echo $row->specialty?></span>
						<span class="contact"><b>Contact:</b> <?php echo $row->contact?></span>
